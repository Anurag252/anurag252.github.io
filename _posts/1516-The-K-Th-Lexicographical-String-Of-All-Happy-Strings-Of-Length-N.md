...
tags: [go]
layout: post
problem_statement: "<h2><a href="https://leetcode.com/problems/the-k-th-lexicographical-string-of-all-happy-strings-of-length-n">The k-th Lexicographical String of All Happy Strings of Length n</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>A <strong>happy string</strong> is a string that:</p>
