---
            title: "1507 Check If There Is A Valid Path In A Grid"
            date: "2026-04-27T22:24:04+02:00"
            categories: ["leetcode"]
            tags: [python]
            layout: post
---
            
## [Check if There is a Valid Path in a Grid](https://leetcode.com/problems/check-if-there-is-a-valid-path-in-a-grid) ![image](https://img.shields.io/badge/Difficulty-Medium-orange)
