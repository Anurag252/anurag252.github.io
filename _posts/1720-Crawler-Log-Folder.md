...
tags: [c]
layout: post
problem_statement: "<h2><a href="https://leetcode.com/problems/crawler-log-folder">Crawler Log Folder</a></h2> <img src='https://img.shields.io/badge/Difficulty-Easy-brightgreen' alt='Difficulty: Easy' /><hr><p>The Leetcode file system keeps a log each time some user performs a <em>change folder</em> operation.</p>
