...
tags: [python]
layout: post
problem_statement: "<h2><a href="https://leetcode.com/problems/sum-of-prefix-scores-of-strings">Sum of Prefix Scores of Strings</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>You are given an array <code>words</code> of size <code>n</code> consisting of <strong>non-empty</strong> strings.</p>
