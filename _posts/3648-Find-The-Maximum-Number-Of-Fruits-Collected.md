...
tags: [python]
layout: post
problem_statement: "<h2><a href="https://leetcode.com/problems/find-the-maximum-number-of-fruits-collected">Find the Maximum Number of Fruits Collected</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>There is a game dungeon comprised of&nbsp;<code>n x n</code> rooms arranged in a grid.</p>
