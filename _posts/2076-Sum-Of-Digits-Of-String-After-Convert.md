...
tags: [go]
layout: post
problem_statement: "<h2><a href="https://leetcode.com/problems/sum-of-digits-of-string-after-convert">Sum of Digits of String After Convert</a></h2> <img src='https://img.shields.io/badge/Difficulty-Easy-brightgreen' alt='Difficulty: Easy' /><hr><p>You are given a string <code>s</code> consisting of lowercase English letters, and an integer <code>k</code>.</p>
