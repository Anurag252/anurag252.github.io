...
tags: [python]
layout: post
problem_statement: "<h2><a href="https://leetcode.com/problems/kth-distinct-string-in-an-array">Kth Distinct String in an Array</a></h2> <img src='https://img.shields.io/badge/Difficulty-Easy-brightgreen' alt='Difficulty: Easy' /><hr><p>A <strong>distinct string</strong> is a string that is present only <strong>once</strong> in an array.</p>
