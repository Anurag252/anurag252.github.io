...
tags: [python]
layout: post
problem_statement: "<h2><a href="https://leetcode.com/problems/divide-array-into-arrays-with-max-difference">Divide Array Into Arrays With Max Difference</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given an integer array <code>nums</code> of size <code>n</code> where <code>n</code> is a multiple of 3 and a positive integer <code>k</code>.</p>
