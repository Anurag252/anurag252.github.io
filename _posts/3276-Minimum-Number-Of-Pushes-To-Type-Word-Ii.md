...
tags: [python]
layout: post
problem_statement: "<h2><a href="https://leetcode.com/problems/minimum-number-of-pushes-to-type-word-ii">Minimum Number of Pushes to Type Word II</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given a string <code>word</code> containing lowercase English letters.</p>
