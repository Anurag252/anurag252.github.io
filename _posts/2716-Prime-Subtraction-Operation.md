...
tags: [python]
layout: post
problem_statement: "<h2><a href="https://leetcode.com/problems/prime-subtraction-operation">Prime Subtraction Operation</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given a <strong>0-indexed</strong> integer array <code>nums</code> of length <code>n</code>.</p>
