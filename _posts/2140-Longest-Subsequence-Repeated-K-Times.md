...
tags: [python]
layout: post
problem_statement: "<h2><a href="https://leetcode.com/problems/longest-subsequence-repeated-k-times">Longest Subsequence Repeated k Times</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>You are given a string <code>s</code> of length <code>n</code>, and an integer <code>k</code>. You are tasked to find the <strong>longest subsequence repeated</strong> <code>k</code> times in string <code>s</code>.</p>
